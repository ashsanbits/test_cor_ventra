...
@Component({
  ...
  templateUrl: './event-videos.page.html',
  styleUrls: ['./event-videos.page.scss'],
})
export class EventVideosPage implements OnInit {
  files: any = [];
  ...
  loadFiles() {
    ...
    this.file.listDir(filepath, 'event_downloads').then(
      res => {
        console.log(res);
        this.files = res;
